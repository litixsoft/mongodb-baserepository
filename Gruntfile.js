...
module.exports = function (grunt) {
    ...
    grunt.registerTask('test', ['git:commitHook', 'clean:jasmine', 'eslint:all', 'jasmine_node:test']);
    grunt.registerTask('cover', ['clean:coverage', 'eslint:all', 'bgShell:coverage', 'open:coverage']);
    grunt.registerTask('ci', ['clean:ci', 'eslint:jslint', 'eslint:checkstyle', 'jasmine_node:ci', 'bgShell:coverage', 'bgShell:cobertura']);
